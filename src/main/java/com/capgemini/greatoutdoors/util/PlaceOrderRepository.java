...
static 	List<PlaceAnOrder>place = new ArrayList();
	static {
		...
		PlaceAnOrder placeorder1 = new PlaceAnOrder("102","A102","102",(byte)04,d1,d1,1450.0);
		PlaceAnOrder placeorder2 = new PlaceAnOrder("103","A103","103",(byte)05,d2,d2,2000.0);
		PlaceAnOrder placeorder3 = new PlaceAnOrder("104","A104","104",(byte)06,d3,d3,784.0);
		PlaceAnOrder placeorder4 = new PlaceAnOrder("105","A105","105",(byte)07,d4,d4,1546.0);
